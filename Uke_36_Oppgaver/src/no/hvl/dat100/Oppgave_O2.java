...
public class Oppgave_O2 
{
	...
	public static void main(String[] args) 
	{
		for (int i=1; i<10;i++)
		{
			...
			{
				i--;
				showMessageDialog(null, "skriv inn gokjent tall");
			}
			...
			else
			{
				...
				{
				showMessageDialog(null, "Gratulere du fikk A med dine: " + Poeng + " poeng.");
				}
				...
				{
					showMessageDialog(null, "Gratulere du fikk E med dine: " + Poeng + " poeng.");
				}
				else if (0<=Poeng && Poeng<=39) 
				{
					showMessageDialog(null, "Du fikk F med dine: " + Poeng + " poeng.");
				}
			}	
		}
	}
